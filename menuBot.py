...
# -----------------------------------------------------------------------
m_main = Menu("Главное меню", buttons=["Развлечения", "Игры", "Погода", "Симпсоны", "Помощь","ДЗ"])
...
m_fun = Menu("Развлечения", buttons=["Прислать лису", "Прислать анекдот", "Прислать фильм", "Прислать курсы", "Угадай кто?", "Выход"], parent=m_main, module="fun")
